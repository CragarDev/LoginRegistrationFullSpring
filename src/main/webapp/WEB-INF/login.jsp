        ...
        <%@taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
                ...
                <%@ page isErrorPage="true" %>
                    ...
                    <head>
                        <meta charset="UTF-8" />
                        <title>Craig Burke - Login/Register</title>
                        <!-- Bootstrap -->
                        <!-- CSS only -->
                    ...
                    <body>
                        ...
                        <div class="container mt-5 w-75">
                            ...
                            <!-- Page Titles -->
                            <div>
                                <h1 class="bg-primary text-light text-center ps-5">Welcome to Login and Registration
                                </h1>
                                <h1 class="bg-primary text-light text-center ps-5 mb-5">Please Log In or Register!</h1>
                            </div>
