        ...
        <%@taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
                ...
                <%@ page isErrorPage="true" %>
                    ...
                    <head>
                        <meta charset="UTF-8" />
                        <title>Craig Burke - Login and Registration - dashboard</title>
                        <!-- Bootstrap -->
                        <!-- CSS only -->
                    ...
                    <body>
                        ...
                        <div class="container text-center">
                            ...
                            <div>
                                <h1 class="bg-dark text-light ps-5">Welcome to Login and Registration</h1>
                            ...
                            <div>
                                <h1 class="bg-primary text-light ps-5">Welcome <span
                                        class="text-primary ">${user.firstName} ${user.lastName}</span>, to the
                                    Login and Registration Dashboard</h1>
                            </div>
